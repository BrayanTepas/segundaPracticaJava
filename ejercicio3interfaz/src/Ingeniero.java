package ejercicio3interfaz.src; // Declara el paquete al que pertenece la clase Ingeniero.
...
public class Ingeniero implements IProfesion {
    ...
    // Permite crear un objeto Ingeniero sin inicializar sus atributos nombre y especialidad
    public Ingeniero() {
    }
    ...
    // Permite a otras clases obtener el valor del nombre del ingeniero.
    public String getNombre() {
        return nombre;
    }

    // Método setter para el atributo 'nombre'.
    // Permite a otras clases establecer o cambiar el valor del nombre del ingeniero.
    ...
    public double calcularSueldo() {
        // Aquí se define la lógica para calcular el sueldo de un Ingeniero.
        // Este valor es el que será retornado y utilizado por la clase 'Main'
        // cuando llame a ingeniero.calcularSueldo().
        return 4000.0; // Sueldo fijo para el ingeniero
    }
}